...
interface NoteDAO {
    ...
    */
    ...
    suspend fun insertNote(note:Note):Long  //return the id

    /*
    similarly you can write multiple insert function. Example:
    -  @Insert
       suspend insertNote2(note:Note)
    -  Add multiple object
       @Insert
       suspend insertNotes(note1:Note,note2:Note,note3:Note)
    -  Add a list of object
       @Insert
       suspend insertNoteList(notes:List<Note>)
    -  Add a single object and a list of object
       @Insert
       suspend insertNoteList(note:Note,notes:List<Note>)
    */
